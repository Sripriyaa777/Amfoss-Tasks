...
BOT_TOKEN = "7544560138:AAFcOSu2AZisuKlM0dDUiWsgOi9Wa8LMa4Q"
API_KEY = "AIzaSyCOaIw53eXgEJU9DC-GuUqM3qftyjLosXw"
...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'add_book':
        await query.edit_message_text(text="Please send the book title and preview link separated by a comma (e.g., 'Book Title, https://books.google.co.in/books?id=9MHP4KnjF9sC&newbks=0&hl=en&source=newbks_fb&redir_esc=y")
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_action == 'add_book':
        try:
            ...
            await update.message.reply_text("Please send the book title and preview link in the correct format (e.g., 'Book Title, http://link.com').")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("📚 Welcome to Book Wizards Bot! Looking for your next great read? You've found the perfect place. Happy reading!")
